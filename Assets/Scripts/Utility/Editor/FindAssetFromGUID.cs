...
public class FindAssetFromGUID : EditorWindow
{
	string guid = "";
	string path = "";
	[MenuItem( "Scripts/Find Asset From GUID" )]
	static void CreateWindow()
	{
		FindAssetFromGUID window = ( FindAssetFromGUID )EditorWindow.GetWindowWithRect( typeof( FindAssetFromGUID ), new Rect( 0, 0, 400, 120 ) );
	}
