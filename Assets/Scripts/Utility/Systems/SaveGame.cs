...
namespace Save
{
    ...
    public abstract class BaseSave
    {
        ...
        {
            bool IsMainThread();
            void ScheduleSave( BaseSave save );
        }
        ...
        [JsonIgnore] public IThreadManager threadManager;
        [JsonIgnore] public bool pendingSave;
        [JsonIgnore] public bool alwaysAutoSave;
    ...
    public abstract class JSONSave : BaseSave
    {
        ...
        {
            if ( threadManager != null && !threadManager.IsMainThread() )
            {
                threadManager.ScheduleSave( this );
                return;
            }
...
public static partial class Utility
{
    ...
    public static void Write( this BinaryWriter writer, object value )
    {
        ...
        else if ( type == typeof( PhysicsMaterial ) )
        {
            Utility.Write( writer, Utility.GetResourcePath( value as PhysicsMaterial ) );
        }
#endif
        ...
        {
            Debug.LogError( "Write Error: Failed to write object of type: " + type.ToString() );
        }
    }
    ...
    public static object ReadObject( this BinaryReader reader, Type type )
    {
        ...
        {
            var path = reader.ReadString();
            return Resources.Load<PhysicsMaterial>( path );
        }
