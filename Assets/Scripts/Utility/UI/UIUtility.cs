...
public static partial class Utility
{
	...
	public static Sequence FadeUIElement( this VisualElement element, float target, float timeSec )
	{
		element.visible = true;
		return DOTween.Sequence()
			.Append( DOTween.To( () => element.style.opacity.value, x => element.style.opacity = x, target, timeSec ) )
			.OnComplete( () => element.visible = target != 0.0f );
	}
	...
	public class UI
	{
		...
		public class CounterLabel
		{
			...
			float targetTime;
			int rootCount;
			public int lastDisplayedCount { get; private set; } = 0;
