...
public static partial class Utility
{
    ...
    public abstract class IRandom
    {
        ...
        public Vector2 insideUnitCircle => Range( 0, 1.0f ) * Mathf.Sqrt( value ) * onUnitCircle;
        ...
        public int Range( IntervalInt range ) => Range( range.First, range.Second + 1 );
    ...
    public static UnityRandom DefaultRng
    {
        get
        {
