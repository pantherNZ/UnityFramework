...
public static partial class Utility
{
    ...
    public static uint ToHex( this Color colour, bool includeAlpha = false )
    {
        uint r = ( uint )( colour.r * 255.0f ) << 0x10;
        uint g = ( uint )( colour.g * 255.0f ) << 0x08;
        uint b = ( uint )( colour.b * 255.0f );
        uint a = includeAlpha ? ( ( uint )( colour.a * 255.0f ) << 0x18 ) : 0;
        return a | r | g | b;
    }
