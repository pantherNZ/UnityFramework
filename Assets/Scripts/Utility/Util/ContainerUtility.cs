...
public static partial class Utility
{
    ...
    public static IEnumerable<T> ReverseIterate<T>( this IList<T> list )
    {
    ...
    public static void RemoveAll<TKey, TValue>( this Dictionary<TKey, TValue> dict, Func<KeyValuePair<TKey, TValue>, bool> removeIf )
    {
