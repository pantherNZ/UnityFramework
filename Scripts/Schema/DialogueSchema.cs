...
namespace Schema.Story
{
	...
	public class DialogueSchema : Audio.AudioDataSchema, ILoreDisplay
	{
		LoreDisplayData ILoreDisplay.DisplayData
		{
			get => GlobalConstantsHandler.FTUEConstants.relayUiDisplayData;
		}
